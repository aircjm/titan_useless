...
import com.aircjm.titan.vo.request.LoginAccountRequest;
...
public class LoginController {
    ...
    public LoginAccountResponse loginAccount(@RequestBody @Valid LoginAccountRequest request) {
        LoginParam loginParam = new LoginParam();
        loginParam.setUsername(request.getUserName());
