...
import com.aircjm.titan.interceptor.AdminInterceptor;
    ...
    public WebMvcConfigurer webMvcConfigurer() {
        return new WebMvcConfigurer() {
            ...
            public void addResourceHandlers(ResourceHandlerRegistry registry) {
                String mediaResource = FILE_PROTOCOL + DiceConsts.USER_HOME + DiceConsts.PROJECT_HOME + DiceConsts.MEDIA_DIR;
